...
const UltimasOfertas = () => {
  return (
  <>
    <p className="p-2 font-serif text-xl text-center bg-blue-200"><strong>¡ULTIMAS OFERTAS!</strong></p>
    <div className="flex flex-wrap justify-center w-full p-0 m-0 font-serif bg-blue-200">
      <ul className="m-4 font-serif bg-blue-500 rounded-lg rounded-t-xl item-center w-80 h-80">
        ...
        <li className="m-2 text-center bg-blue-200 rounded-lg">
          <button className="rounded sm:ease-in-out sm:delay-80 sm:hover:-translate-y-1 sm:hover:scale-110 sm:hover:bg-blend-hard-light sm:duration-300"><a  target="blank" src={Tele}> mas info aqui</a></button>
        </li>
      </ul>
      ...
      <ul className="m-4 font-serif bg-blue-500 rounded-lg rounded-t-xl item-center w-80 h-80">
        ...
        <li className="m-2 text-center bg-blue-200 rounded-lg">
        <button className="rounded sm:ease-in-out sm:delay-80 sm:hover:-translate-y-1 sm:hover:scale-110 sm:hover:bg-blend-hard-light sm:duration-300"><a target="blank" href=""> mas info aqui</a></button>
        </li>
      </ul>
